...
try:
    ...
    print(f"Error creating new CSV file at: {file_path}")
...
try:
    ...
    print("Error creating moded_with_embeddings")
...
try:
    ...
    print("Error creating embeddings table!")
    connection.rollback()
...
try:
    ...
    print("Successfully removed 'moded.csv' and 'moded_with_embeddings.csv' from disk.")
except OSError as e:
